...
| <a name="input_autoscaling_enabled"></a> [autoscaling\_enabled](#autoscaling\_enabled) | Enable to automatically expand your cluster's storage in response to increased usage| `bool` | `true` | no |
